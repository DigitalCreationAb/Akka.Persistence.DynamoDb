...
namespace Akka.Persistence.DynamoDb.Test.Query
{
    ...
    public class DynamoDbCurrentPersistenceIdsSpec : CurrentPersistenceIdsSpec
    {
        public DynamoDbCurrentPersistenceIdsSpec(DynamoDbTestCollection.Fixture fixture)
